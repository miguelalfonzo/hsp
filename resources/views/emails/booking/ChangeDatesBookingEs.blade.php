...
<head>
  ...
  <title>{{ config('app.name') }} - Modificación de la Reserva</title>
  <style type="text/css">
        ...
        <td bgcolor="#ffffff" class="header">
          <table  class="w-100" align="left" border="0" cellpadding="0" cellspacing="0" >  
            <tr>
              ...
              <td class="headerfamily logo-padding" height="70">
                ...
                <h5 align="right">Reserva - #{{$information['header'][0]->BookingId}}</h5>
          ...
          <table  align="left" border="0" cellpadding="0" cellspacing="0" class="w-100">  
            <tr>
              ...
              <p class="font-14">Hola <strong>{{ucfirst($information['header'][0]->GuestFullName)}}</strong><br>Espero te encuentres muy bien , el siguiente correo es para informarle sobre la modificación de su reserva.</p>

              <h5 class="spacing color-h5">Información de Reserva </h5>
                ...
                <p>Si tienes alguna duda o requieres asistencia por favor llama {{$information['contact'][1]}} o mándanos un correo a {{$information['contact'][0]}}</p>
