...
<head>
  ...
  <title>{{ config('app.name') }} - Cancelación de la Reserva</title>
  <style type="text/css">
        ...
        <td bgcolor="#ffffff" class="header">
          ...
          <table  align="left" border="0" cellpadding="0" cellspacing="0" class="w-100">  
            <tr>
              ...
              <p class="font-14">Hola <strong>{{ucfirst($information['header'][0]->GuestFullName)}}</strong><br>Espero te encuentres muy bien , el siguiente correo es para informar sobre la cancelación de su reserva .</p>
