...
<head>
  ...
  <title>{{ config('app.name') }} - Modification Booking</title>
        ...
        <td bgcolor="#ffffff" class="header">
          ...
          <table  align="left" border="0" cellpadding="0" cellspacing="0" class="w-100">  
            <tr>
              ...
              <p class="font-14">Hello <strong>{{ucfirst($information['header'][0]->GuestFullName)}}</strong><br> I hope you are very well, the following email is to inform you about the modification of your booking.</p>
